...
namespace PortfolioUnleashed.Controllers
{
    public class PortfolioController : Controller
    {
        ...
        public ActionResult PortfolioCreateEdit(int id = -1)
        {
            ...
            if (projects != null)//there are projects
            {
        ...
        public ActionResult PortfolioCreateEdit(VMEditingPortfolio model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (existing != null)//portfolio exists
                {
                    ...
                    existing.URL = (model.URL != null) ? model.URL : "http://www.gurgaonsaath.com/images/default-product-image.jpg";
                ...
                int userId = (isNewPortoflio) ? WebSecurity.CurrentUserId : model.UserId;
                ...
                if(Roles.IsUserInRole(WebSecurity.CurrentUserName,"Admin"))return RedirectToAction("AllPortfolios", "Admin");
                else return RedirectToAction("Account", "User", new { id = WebSecurity.CurrentUserId });
            }
            Portfolio port = new Portfolio();
            port.Id = model.Id;
            port.Title = model.Title;
            port.URL = (model.URL != null) ? model.URL : "http://www.gurgaonsaath.com/images/default-product-image.jpg";
            ...
            if (Roles.IsUserInRole(WebSecurity.CurrentUserName, "Admin")) return RedirectToAction("AllPortfolios", "Admin");
            else return View(model: new VMEditingPortfolio(port, model.UserId) {ProjectCatalog = model.ProjectCatalog});
        }
